public abstract class Authentification {
    ...
    public void login(){
        if(verifierIdentite()){
            estConnect= true;
            System.out.println(utilisateur + " est connecté à notre systeme informatique.");
        } else{
            System.out.println("Echec de connexion de " +utilisateur +". " +"Veuillez verifier vos identifiant");
